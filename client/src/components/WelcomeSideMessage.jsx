export const WelcomeSideMessage = () => {
  return (
    <div className="font-poppins rounded-md lg:w-80 overflow-hidden md:w-52 hidden md:block border-2 shadow border-[#e5e5e5] h-auto text-black bg-[#f2f2f2]">
      ...
      <div className="text-center text-[15px] font- px-3 pb-3">
        e-Blog makes blogging easy and engaging for everyone. Publish, share,
        and connect with a vibrant community. Explore topics, follow bloggers,
